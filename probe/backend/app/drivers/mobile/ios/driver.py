"""
IOSTestDriver — stub for future implementation.

This module is an extension point. Do NOT implement mobile testing here.
The full implementation will use Appium.
...
class IOSTestDriver(TestDriver):
    """
    Future iOS test driver using Appium.
    ...
    async def initialize(self) -> None:
        raise DriverError("IOSTestDriver is not implemented in V1")
